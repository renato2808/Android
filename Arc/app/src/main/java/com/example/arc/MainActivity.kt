...
class MainActivity : BaseActivity(), CoroutineScope {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        launch {
            ...
            ​
            adapter = StoresListAdapter(storesResponse.stores, object: StoresListAdapter.Actions {
                override fun onStoreSelected(storeId: Long) {
                    Toast.makeText(thisActivityContext, "Pet Store $storeId selected. Au au!", Toast.LENGTH_SHORT).show()
                }
            })
